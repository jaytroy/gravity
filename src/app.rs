use crate::triangle::{Triangle, create_triangle_vertices, setup_triangle};
...
impl App {
    ...
    pub fn run(&mut self) {
        ...
        let egui_ctx = egui_sdl2_gl::egui::Context::default();
        ...
        let inc: f32 = 0.1;
        let transform1 = Transform::new_centered(inc);
        let transform2 = Transform::new_centered(inc);
        let mut entity1: Entity = Entity::new(triangle1, transform1);
        let mut entity2: Entity = Entity::new(triangle2, transform2);
        ...
        'main: loop {
            ...
            if mouse.is_mouse_button_pressed(sdl2::mouse::MouseButton::Left) {
                let mut entity = self.entities.get_mut(0).unwrap();
                entity.transform.offset_x += mouse.x() as f32 / 400.0;
                entity.transform.offset_y += mouse.y() as f32 / 300.0;
            }

            // Animation logic here
            for entity in &mut self.entities {
                entity.triangle.clamp_euclid();
                // Define a transform struct.
                // Will be separate from triangle itself.
                // Will hold posit data.
                model.extend(entity.create_vertices());
                entity.rotate(inc);
            }
            ...
            unsafe {
                ...
                let num_entities = self.entities.len() as i32;
            ...
            egui_sdl2_gl::egui::Window::new("Controls").show(&egui_ctx, |ui| {
                ...
                if ui.button("Add").clicked() {
                    ...
                    //and functionality to make this click to add
                    let transform = Transform::new_centered(inc);
                    let entity = Entity::new(triangle, transform);
